...
<body>
    <div class="container">
        <h1>予定を追加する</h1>
        <form action="https://docs.google.com/forms/d/e/1FAIpQLSfXpILrFamfJlp7NMh0kus1zDu03DSu8hzD-HUlWSVaEpP1xQ/formResponse" method="GET">
            ...
            <div class="form-group">
                ...
                <textarea id="comments" name="entry.404331169" rows="4" required></textarea>
            </div>
